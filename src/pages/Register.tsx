    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 bg-background">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm mb-8">Bắt đầu hành trình âm nhạc</p>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-xs tracking-wider text-muted-foreground block mb-2">HỌ TÊN</label>
              <input
                type="text"
                value={name}

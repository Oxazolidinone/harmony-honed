...
const Login = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      {/* Gradient overlay — darker on form side, lighter on scenery */}
      ...
      {/* Form container — right on desktop, centered on mobile */}
      <div className="relative z-10 min-h-screen flex items-center justify-center lg:justify-end px-6 lg:px-20">
        ...
        >
          ...
          <h1 className="font-display text-4xl mb-2 text-white drop-shadow-lg">Đăng nhập</h1>
          <p className="text-white/60 text-sm mb-8 font-body">Chào mừng trở lại</p>

...
const AlbumDetail = () => {
  ...
  return (
    <div>
      {/* Header */}
      <div className="px-6 md:px-10 py-8 flex flex-col md:flex-row gap-8 items-end border-b border-border">
        ...
        <motion.div
          ...
          className="w-48 h-48 md:w-56 md:h-56 overflow-hidden flex-shrink-0 shadow-lg"
        >
        ...
        {album.songs.map((song, i) => {
          ...
          return (
            <motion.button
              ...
              className={`w-full flex items-center gap-4 py-4 px-2 border-b border-border hover:bg-card/50 transition-colors group text-left ${isActive ? "text-primary" : ""}`}
            >

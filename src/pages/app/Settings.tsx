  ...
  return (
    <div className="min-h-full relative">
      ...
      <div className="px-6 md:px-10 py-10 max-w-2xl">
        <p className="text-[10px] tracking-[0.4em] text-foreground/70/60 font-body mb-3">ACCOUNT</p>
        <motion.h1
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xs tracking-[0.3em] text-foreground/70 font-body">HỒ SƠ</h2>
          </div>
          <div className="flex items-center gap-4 p-5 bg-card/40 backdrop-blur-sm rounded-2xl">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-foreground/70 font-body">{user?.email}</p>
            </div>
        ...
        <section className="mb-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <Crown size={14} className="text-foreground/70" />
            <h2 className="text-xs tracking-[0.3em] text-foreground/70 font-body">GÓI ĐĂNG KÝ</h2>
          </div>
          <div className="bg-card/40 backdrop-blur-sm rounded-2xl p-6">
            ...
            {user?.plan === "free" ? (
              <div>
                <p className="text-sm text-foreground/70 mb-5 font-body leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div className="border border-primary/30 p-5 rounded-2xl hover:border-primary transition-colors cursor-pointer bg-primary/5 group">
                    ...
                    <p className="text-xs text-foreground/70 font-body">/tháng · 1 tài khoản</p>
                  </div>
                  <div className="border border-border/40 p-5 rounded-2xl hover:border-primary transition-colors cursor-pointer group">
                    ...
                    <p className="text-xs text-foreground/70 font-body">/tháng · tối đa 6 tài khoản</p>
                  </div>
                </div>
        ...
        <section className="mb-10">
          ...
          <div className="bg-card/40 backdrop-blur-sm rounded-2xl overflow-hidden">
            {[
              ...
              >
                <item.icon size={16} className="text-foreground/70/60" />
                <div className="flex-1">
                  <p className="text-sm font-display italic group-hover:text-primary transition-colors">{item.label}</p>
                  <p className="text-xs text-foreground/70 font-body">{item.desc}</p>
                </div>
              </button>
            ))}
          </div>
